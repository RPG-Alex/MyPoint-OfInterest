...
class MainActivity : AppCompatActivity() {
    ...
    fun goToLocation(location:String){
        val thisLocationIntent: Intent = Intent(this,LocationInfo::class.java)
        startActivity(thisLocationIntent)

        /*
                    relative_layout.setOnClickListener{
                val thisLocation = txtTitle.text.toString()
                goToLocation(thisLocation)
            }
         */
    }
    }
